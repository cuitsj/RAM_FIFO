...
HD_PWD='E:/xintu_work/ram/ram_ip/ram_ip.runs/sdp_ram_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdp_ram_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdp_ram_ip.tcl
