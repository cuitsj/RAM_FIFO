...
#
# Generated by export_simulation on Fri Oct 14 10:02:08 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './tdp_ram_ip.sh' script.

./tdp_ram_ip.sh -reset_run
...
./tdp_ram_ip.sh -noclean_files

For more information on the script, please type './tdp_ram_ip.sh -help'.
